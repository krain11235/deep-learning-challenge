...
How many neurons, layers, and activation functions did you select for your neural network model, and why? I tried every random thing I could. It was trial and error.
Were you able to achieve the target model performance? Yes
What steps did you take in your attempts to increase model performance? I tried a lot of different things including binning the ASK_AMT, but that didn improve results. Then, realizing NAME values appeared more than once, I put those back in and only took counts over fifty. That worked.
